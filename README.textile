...
First I'll go through the build files, Ant/Ivy or Maven, then detail Avro protocol definition and main routine of the sample Mail application.
...
h3. Main.java - the main() routine of the Mail sample
