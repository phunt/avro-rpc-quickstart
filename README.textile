...
The toplevel "lib/python" directory contains the Avro python egg. This is newly available in the 1.3.0 release.
...
<code>
PYTHONPATH=../../../lib/python/avro-1.3.0-py2.6.egg ./start_server.py
</code>

then in a separate shell run:

<code>
PYTHONPATH=../../../lib/python/avro-1.3.0-py2.6.egg ./send_message.py avro_user pat Hello_World
</code>
...
The toplevel "lib/ruby" directory contains the Avro ruby library. As of 1.3.0 a gem is not available.
